...
if(isset($_POST['enviar'])) {
  ...
  $var_dni = $_POST['dni'];  
  $var_cuenta = $_POST['cuenta'];
//Crear objeto cuentaBancaria
$cuentaBancaria = new cuentaBancaria($var_nombre, $var_dni, $var_cuenta);
//Crear objeto cuentaBancariaDAO
$cuentaBancariaDAO = new cuentaBancariaDAO();
//Actualizar cuentaBancaria
$cuentaBancariaDAO->actualizarCuenta($var_codigo, $cuentaBancaria);
...
<div class="container">
  ...
  <form method="post" action="">
    ...
    <div class="form-group">
      <label for="supercodigo">Cuenta:</label>
